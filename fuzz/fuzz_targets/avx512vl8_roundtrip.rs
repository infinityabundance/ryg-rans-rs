...
fuzz_target!(|data: &[u8]| {
    ...
    // The kernel is compile-time gated on avx512bw; without the feature
    // this target is a no-op, mirroring the crate's portable-build behavior.
    #[cfg(all(
