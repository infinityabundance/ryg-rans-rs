...
| MODEL_CACHE.METRICS.2 | MEDIUM | Cancelled coalesced lookups violate `hits + misses == lookups`: a waiting caller increments `lookups`; if it cancels it returns without incrementing hits or misses | OPEN | 
