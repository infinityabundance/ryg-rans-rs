...
**Version 0.1.30** (workspace) · **Phase L** · **105 tests passing** · Evidence status: **test-verified** (not sealed)
...
- Version **0.1.30**, shared with the workspace.  The crate follows semantic
