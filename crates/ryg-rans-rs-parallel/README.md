...
**Version 0.2.0** (workspace) · **Phase L** · **105 tests passing** · Evidence status: **test-verified** (not sealed)
...
- Version **0.2.0**, shared with the workspace.  The crate follows semantic
