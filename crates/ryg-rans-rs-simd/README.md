...
**Version: 0.3.0** (workspace) · default build: 27 tests (22 unit + 4 disassembly courts +
...
`0.3.0` (workspace-wide). Format invariants that apply to every kernel in this crate:
