...
**Version: 0.5.0** · Schema v1 · 3 core types (+ std-gated performance types) · 1 test (doc test)
...
- **Version**: 0.4.0 (workspace crates). Schema version 1.
...
*Part of the ryg-rans-rs project. Version **0.5.0**. Phase M custodian documentation pass.*
